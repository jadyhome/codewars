////////////////////////////////////////////////////////////////////////
// PROMPT
// https://www.codewars.com/kata/5866e6992e8d9cdbcd00040a/train/javascript

// This Kata is intended as a small challenge for my students
// All Star Code Challenge #28

// You've been annoyed by weather reports one time too many!
// Celsius...Fahrenheit...why don't they ever give both!?

// Create a function called convertCF()/convert_c_f()
// (depending on language) that accepts 2 arguments, an integer of the temperature, and a string of length 1 ("c" or "f")
// denoting which scale the integer should be converted to (Celsius and Fahrenheit, respectively).
