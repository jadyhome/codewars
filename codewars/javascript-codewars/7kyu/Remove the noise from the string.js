...
// Unfortunately our machine introduces noise,
// which means that our message arrives with characters like: %$&/#·@|º\ª within our original message.
...
function removeNoise(str) {
  return str.replace(/\\/g, "").replace(/[%$&/#·@|ºª]/g, "");
}
