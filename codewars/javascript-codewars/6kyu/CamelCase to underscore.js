////////////////////////////////////////////////////////////////////////
// PROMPT
// https://www.codewars.com/kata/5b1956a7803388baae00003a/javascript
...
// You also have some calculation tests.
// Make sure the results don't get split by underscores.
// So only add an underscore in front of the first number.

// Also Some people already used underscore names in their tests.
// You don't want to change them. But if they are not split correct you should adjust them.

// Some of your colleagues mark their tests with a leading and trailing underscore. Don't remove this.

// And of course you should handle empty strings to avoid unnecessary errors.
// Just return an empty string then.
