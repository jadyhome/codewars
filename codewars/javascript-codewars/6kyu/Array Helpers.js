...
// square - using the map() method
Array.prototype.square = function () {
  return this.map((sq) => sq * sq);
};

// cube - using the map() method
Array.prototype.cube = function () {
  return this.map((cu) => cu * cu * cu);
};

// average - using the reduce() method
...
Array.prototype.sum = function () {
  return this.reduce((c, d) => c + d);
};

// even - using the filter() method
Array.prototype.even = function () {
  return this.filter((e) => e % 2 === 0);
};

// odd - using the filter() method
