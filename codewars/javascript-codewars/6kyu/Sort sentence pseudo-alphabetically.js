...
// write a method that will return a sentence made up of the same words, but sorted by their first letter. 
...
// and upper case letters are sorted V -> T -> O -> M -> L -> C.
////////////////////////////////////////////////////////////////////////
...
function sort(sentence) {
  sentence = sentence.replace(/[^a-z0-9 ]/gi, "").split(" ");
  let lower = sentence
    .filter((l) => l.charAt(0).match(/[a-z]/g))
    .sort((a, b) => a.localeCompare(b));
  let upper = sentence
    .filter((u) => u.charAt(0).match(/[A-Z]/g))
    .sort((c, d) => d.localeCompare(c));
