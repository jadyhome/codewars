...
// and was the first alphabetic script to have distinct letters for vowels as well as consonants.
// It is the ancestor of the Latin and Cyrillic scripts.
// Apart from its use in writing the Greek language, both in its ancient and its modern forms,
...
// takes a string as input and returns it in the form of (L33T+Grεεκ)Case.
...
function GrεεκL33t(str) {
  ...
  for (let l = 0; l < str.length; l++) {
    if (str[l].match(/[abdeiknoprtuvwxy]/gi)) {
      leetspeak.push((str[l] = cases[str[l]]));
    } else {
      leetspeak.push(str[l]);
    }
  }
