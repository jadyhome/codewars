...
// adds the question property to each object in the input array where the developer has not provided the relevant details (marked with a null value). 
...
function askForMissingDetails(list) {
  let developersToContact = [];

  list = list.forEach((developer) => {
    for (let key in developer) {
      if (developer[key] === null) {
        developersToContact.push({
          ...developer,
