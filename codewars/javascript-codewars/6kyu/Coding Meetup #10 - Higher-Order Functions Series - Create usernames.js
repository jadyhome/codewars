...
function addUsername(list) {
  let username = list.map((developers) => {
    return {
      ...developers,
      username:
        developers.firstName.toLowerCase() +
        developers.lastName.charAt(0).toLowerCase() +
        String(Date.prototype.getFullYear() - developers.age),
    };
  });
