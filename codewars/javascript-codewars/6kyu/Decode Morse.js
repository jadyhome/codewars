////////////////////////////////////////////////////////////////////////
// PROMPT
// https://www.codewars.com/kata/54b0306c56f22d0bf9000ffb/train/javascript
...
// There are long and short beeps, the longer ones roughly three times as long as the shorter ones.
...
function decode(str) {
  ...
  let decoded = str.split(" ").map((x) => (x = morse[x]));
  if (str === "") {
    return "";
  } else {
    return decoded.join("");
