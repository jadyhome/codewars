...
// formatted as in the list above for example 'Africa' will always start with upper-case 'A'.
...
function allContinents(list) {
  const theContinents = ["Africa", "Americas", "Asia", "Europe", "Oceania"];

  return theContinents.every((continents) =>
    list.some((geographicZone) => geographicZone.continent === continents)
  )
    ? true
    : false;
}
