////////////////////////////////////////////////////////////////////////
// PROMPT
// https://www.codewars.com/kata/55a5d97d81a010881800004a/train/javascript

// Create an English to Enigeliisohe Translator, which after each consonant
// or semivowel inserts in lower case form the last vowel which precedes it in the alphabet.

// Trivia:
// Enigeliisohe is a language based on written English, and Esper' phonetics,
// in which each letter in written English is converted to the Esperanto name of that letter.

// Most of the Esper' consonants are pronounced the same as in English,
// but since there are exceptions, here are some key examples how certain Esper' letter names are pronounced...
...
// Accented letters are unsupported, and therefore letters with diacritic marks,
// if encountered, should remain unchanged and not get a vowel attached to them.
...
var toexuto = function (text) {
  ...
  text = text.replace(/./gi, (t) => {
    if (esperKeys[t.toLowerCase()]) {
      translatedText.push(t + esperKeys[t.toLowerCase()]);
    } else {
