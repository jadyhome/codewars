...
// you have volunteered to create a function
...
// before being passed to your function although you will need to account for adding trailing zeros if they are missing 
...
function formatMoney(amount) {
  let dollar = "$"
  let money = dollar + amount.toFixed(2)
  return `${money}`
}
